...
import ModalBg from "../View/modalBg";
import LookTurnCard from "../View/lookTurnCard";
...
export default class ScenePickCard extends Scene {
	constructor() {
		...
		this.lookTurnCard = new LookTurnCard()
		this.lookTurnCard.setActive(true)
	}
